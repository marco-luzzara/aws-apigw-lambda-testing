...
import org.example.ui.testcontainer.model.LocalstackGlobals;
import org.example.ui.testcontainer.model.ScriptResults;
...
public class AppContainer extends LocalStackContainer {
    ...
    public void createApiForTestFunction() {
        Objects.requireNonNull(this.restApiId);
